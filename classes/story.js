...
function Story(route, polyline, speed) {
    this.markers = route.route;
    ...
    for(var index = 0; index < this.markers.length; index++) {
        ...
        currentMarker.countdown = Math.round(currentMarker.distanceFromPrev / speed);
    }

    this.total_distance = route.getTotalDistance();
}
